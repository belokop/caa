...
//
// to have this script apply to input.myclass, instead of the default input[type=color]
...
// swatches - Initial colors in the swatch, must be an array of 10 colors.
//
// init:
...
(function($){
  ...
  $.fn.mColorPicker.drawPickerTriggers = function ($t) {
    ...
    var color = $t.val(),
        ...
        flt = $t.css('float'),
        image = (color == 'transparent')? "url('" + $o.imageFolder + "/mColorPicker_grid.gif')": '',
        colorPicker = '';
    ...
    if (hidden) {
      ...
      $('#' + id).css({
        ...
        '<span style="cursor:pointer;" id="icp_' + id + '" class="mColorPickerTrigger"><img src="' + $o.imageFolder + 'mColorPicker_color.png" style="border:0;margin:0 0 0 3px" align="absmiddle"></span>'
  ...
  $.fn.mColorPicker.drawPicker = function () {
    ...
    $('#mColorPickerImg').css({
      ...
      'border':0,
      'cursor':'crosshair',
      'background-image':"url('" + $o.imageFolder + "mColorPicker_colorpicker.png')"
    });
    ...
    $('#mColorPickerImgGray').css({
      ...
      'border':0,
      'cursor':'crosshair',
      'background-image':"url('" + $o.imageFolder + "mColorPicker_graybar.jpg')"
    });
    ...
    $('#mColorPickerFooter').css({
      'background-image':"url('" + $o.imageFolder + "mColorPicker_grid.gif')",
      'position': 'relative',
      'height':'26px'
    });
    ...
    //    if ($.fn.mColorPicker.init.showLogo) $('#mColorPickerFooter').prepend('<a href="http://meta100.com/" title="Meta100 - Designing Fun" alt="Meta100 - Designing Fun" style="float:right;" target="_blank"><img src="' +  $o.imageFolder + 'mColorPicker_meta100.png" title="Meta100 - Designing Fun" alt="Meta100 - Designing Fun" style="border:0;border-left:1px solid #aaa;right:0;position:absolute;"/></a>');
  ...
  $.fn.mColorPicker.setInputColor = function (id, color) {
    ...
    var image = (color == 'transparent')? "url('" + $o.imageFolder + "mColorPicker_grid.gif')": '',
